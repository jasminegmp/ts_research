...
% Last Modified by GUIDE v2.5 05-Jun-2018 10:36:26
...
level = round(slide_pos,1)*10; % round to nearest tenth
if level == 0
    level = 1;
end
...
global seg_length;
% Run script first
gui_ds = new_sum_fastMPdist(linkage, f_name, seg_length);
...
global seg_length;
seg_length = str2num((get(hObject,'String')));
