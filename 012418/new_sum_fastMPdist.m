...
while (size(dist_mat,1) > 1)
    ...
    %do merge
    next_loc_0 = cell2mat(dist_mat(min_idx+1,4));
    next_loc_1 = cell2mat(dist_mat(min_idx+1,5));
    ...
    dist_mat(min_idx + 1,1) = {dist};
    dist_mat(min_idx + 1,2) = {loc_0};
    dist_mat(min_idx + 1,3) = {loc_1};
